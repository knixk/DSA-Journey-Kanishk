    ...
    int lengthOfLongestSubstring(string s)
    {
        ...
        while (i < n && j < n)
        {
            ...
            else
            {
                ...
                what im doing here is basically just setting my i to one greater than the newest dup char, in this way i don't have to go again i guess
                */
            }

            int currentSize = j - i; // + 1 was giving a wrong ans why this? this is correct btw
